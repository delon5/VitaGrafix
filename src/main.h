...
#define OSD_MSG_CONFIG_SAVING        "Saving..."
#define OSD_MSG_CONFIG_SAVED         "Saved"
#define OSD_MSG_CONFIG_SAVED_2       "Restart the game to apply"
#define OSD_MSG_CONFIG_SAVE_FAILED   "Failed to save"

#define VG_VERSION         "v6.0.0"
#define VG_DIR             "ux0:data/VitaGrafix/"

#define STRING_BUFFER_SIZE 1024
#define INPUT_HOOK_NUM     14
...
typedef struct {
    // OSD hook
    bool osd_done;
    volatile bool osd_busy;
    SceUID osd_hook;
    tai_hook_ref_t osd_hook_ref;
    SceUInt64 osd_timer;

    // in-game menu: input hooks hide the game's controls while it is open
    bool menu_ready;
